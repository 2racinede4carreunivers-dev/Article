...
\[
\frac{4^4}{4} + \frac{3^3}{3} + \frac{5^2}{2} + \frac{7^1}{1} + \frac{11^1}{1} + \frac{13^1}{1} + \frac{17^1}{1} + \frac{19^1}{1} + \frac{23^1}{1} + \frac{29^1}{1} = 197
\]

\[
30 - \frac{\log(197)}{\log(10)} - \log(2\pi) - 0.5\log\left(1 - 30^{-2}\right) = 28.50347223
\]
